...
<body>
    ...
    <div
        ...
        <div class="p-5 aos-init aos-animate">
            ...
            <div class="text-center">
                <h2 class="text-3xl font-bold caption">Romeo</h2>
                <h3 class="text-lg mb-2 mt-2">Romeo Montaque</h3>
                <p>Putra Pertama dari Pasangan</p>
                <p class="text-secondary">Bambang &amp; Mulyani</p>
        ...
        <div class="p-5 aos-init aos-animate">
            ...
            <div class="text-center">
                <h2 class="text-3xl font-bold caption">Juliet</h2>
                <h3 class="text-lg mb-2 mt-2">Juliet Capulet</h3>
                <p>Putri Kedua dari Pasangan</p>
                <p class="text-secondary">Joko &amp; Siti</p>
                <p class="mt-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" width="24px" height="24px" class="inline-flex w-4">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z">
    ...
    {{-- Kado --}}
    <div id="hadiah" class="flex flex-col max-w-screen-xl mx-auto mb-32">
        ...
        <div class="mt-4 flex flex-col gap-4 sm:flex-row lg:flex-row xl:flex-row mx-auto">
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    ...
                    {{-- Loop Data --}}
                    <p class="mt-2 text-sm text-gray-500">BNI - 12848264937</p>
                    <p class="mt-2 text-sm text-gray-500">BCA - 57814488</p>
                </div>
            </div>
            ...
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Jl Sultan No.88 B</p>
                </div>
            </div>
        </div>
    </div>
