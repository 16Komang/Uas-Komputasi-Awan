                    ...
                    <div class="max-w-sm">
                        <div class="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                            <img class="rounded-t-lg"
                                src="https://demo.templateflip.com/wonderful-wedding/images/groom.jpg" alt="" />
                            <div class="py-6 px-8 rounded-lg bg-white">
                                <p class="text-gray-700 tracking-wide text-justify">Lorem ipsum dolor sit amet
                                    consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                                <p
            ...
            <div class="flex justify-center items-center">
                <div class="container flex justify-center">
                    <div class="max-w-sm">
                        <div class="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                            <img class="rounded-t-lg"
                                src="https://demo.templateflip.com/wonderful-wedding/images/bride.jpg" alt="" />
                            <div class="py-6 px-8 rounded-lg bg-white">
                                <p class="text-gray-700 tracking-wide text-justify">Lorem ipsum dolor sit amet
                                    consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                                <p
        ...
        <div class="max-w-screen-2xl mx-auto sm:mb-10 lg:grid lg:grid-cols-5 md:grid-cols-none bg-white lg:h-full">
            <div
                ...
                <div class="py-10">
                    ...
                    <div class="flex mb-4">
                        ...
                        <p class="font-bold text-lg text-gray-800 text-left">Church End, Hendon, London, UK</p>
                    </div>
                    <div class="flex">
                        <img class='w-7 mr-2' src="https://cdn-icons-png.flaticon.com/512/2886/2886665.png" alt="" />
                        <p class="font-bold text-lg text-gray-800 text-left">20 Dec 2018, 9AM - 6PM</p>
                    </div>
                    <p class="text-lg text-black text-justify pt-2">Lorem ipsum dolor sit amet, consectetur
                        adipiscing
            ...
            <div class="hidden relative lg:block  lg:col-span-3">
                <img class="absolute inset-0 w-full h-full object-cover object-center"
                    src="https://demo.templateflip.com/wonderful-wedding/images/wedding-party.jpg"
