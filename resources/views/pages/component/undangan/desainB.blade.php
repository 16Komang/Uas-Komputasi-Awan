...
<body>
    ...
    <div id="agenda" class="bg-slate-200 py-8">
        <div class="w-full 2xl:w-3/4 flex items-center justify-center px-8 md:px-32 lg:px-16 2xl:px-0 mx-auto">
            <div class="w-full flex flex-col sm:flex-col md:flex-col lg:flex-col gap-8 mx-auto">
    ...
    <div class="flex items-center justify-center mb-10">
        <div class="rounded-lg bg-gray-200 p-5 w-1/3">
            <div class="flex">
                <span id="link"
                    class="w-full bg-white py-auto py-2.5 text-base font-semibold outline-0">http://127.0.0.1:8000/guest/{{
                    $data['invitation']->id }}</span>
                <span id="copy-btn"
