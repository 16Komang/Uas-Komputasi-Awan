    ...
    <div class="lg:flex">
        <div class="w-full grid grid-cols-1 gap-4 min-h-screen">
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                <div class="mb-4">
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">List Template</h3>
                        <span class="text-base font-normal text-gray-500">
                            Berikut merupakan list template yang terdaftar
                            pada website
                        </span>
                    </div>
                </div>
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr key={i}>
                                            ...
                                            <td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                                                <form method="POST" action="{{ route('destroyTemplate',$t->id) }}" class="flex align-middle items-center hover:underline">
                                                    @csrf
                                                    <button type="submit">
