...
<body>
    ...
    {{-- <div id='guest-book' class="my-10">
        <p class='text-black text-center font-great-vibes text-5xl my-8'>Guest Book</p>
        <div class="flex items-center justify-center px-12 pb-12">
            <div class="mx-auto w-full max-w-[550px] bg-white">
                <form class="py-6 px-9" action="https://formbold.com/s/FORM_ID" method="POST">
                    <div class="mb-5">
                        <label htmlFor="email" class="mb-3 block text-base text-left font-medium text-[#07074D]">
                            Nama
                        </label>
                    ...
                    <div class="">
                        ...
                        <textarea rows="4" name="message" id="message" placeholder="Type your message"
                            class="w-full mb-6 resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
                    </div>
